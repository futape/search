...
Besides the managed value, a value instance also managed a matching score, as well as a highlighted version of the
managed value.  
There are an abstract matcher and value you can extend to build your own, as well as are a few predefined concrete
